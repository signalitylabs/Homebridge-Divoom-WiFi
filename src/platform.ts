 ...
 */
export class HomebridgeDivoomWifi implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    for (const device of divoomDevices) {
      ...
      if (existingAccessory) {
        ...
        new DivoomPlatformAccessory(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new DivoomPlatformAccessory(this, accessory);
